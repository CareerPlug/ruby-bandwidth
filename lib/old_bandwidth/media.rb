...
module OldBandwidth
  MEDIA_PATH = "media"
  # The Media resource lets you upload your media files to OldBandwidth API servers
  class Media
    ...
    # Upload file to the OldBandwidth API server
    # @param client [Client] optional client instance to make requests
    ...
    # Download file from OldBandwidth API server
    # @param client [Client] optional client instance to make requests
    # @param name [String] file name
    ...
    # Remove file from the OldBandwidth API server
    # @param client [Client] optional client instance to make requests
    # @param name [String] file name
    # @example
